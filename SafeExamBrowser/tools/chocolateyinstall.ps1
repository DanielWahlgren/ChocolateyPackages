...
$url        = 'https://github.com/SafeExamBrowser/seb-win-refactoring/releases/download/v3.4.1/SEB_3.4.1.505_x86_Setup.msi' # download url, HTTPS preferred
$url64      = 'https://github.com/SafeExamBrowser/seb-win-refactoring/releases/download/v3.4.1/SEB_3.4.1.505_x64_Setup.msi' # 64bit URL here (HTTPS preferred) or remove - if 
...
$packageArgs = @{
  ...
  softwareName  = 'SafeExamBrowser*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique

  # Checksums are now required as of 0.10.0.
  # To determine checksums, you can get that from the original site if provided.
  # You can also use checksum.exe (choco install checksum) and use it
  # e.g. checksum -t sha256 -f path\to\file
  checksum      = '70A23B2AA2041925313C33ED893B0D4332C19B1CFCC2586DA662B8019BF0FD3E'
  checksumType  = 'sha256' #default is md5, can also be sha1, sha256 or sha512
  checksum64    = '5BA21601D3DFB8823742A167C4CCB73AF2EA6A8164882FE4F12C24F23277232D'
